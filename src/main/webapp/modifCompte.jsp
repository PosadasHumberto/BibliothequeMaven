...
<body class="bg-black">
    ...
    <div class="row text-center m-3">
        <h1 class="text-warning">Modification du compte</h1>
    </div>
    <form class="row justify-content-center" action="" method="">
        <div class="col-lg-4 col-xl-4 col-sm-11">
            <div class="form-group">
                <label for="nom" class="text-white">Nom:</label>
                <input type="text" class="form-control" id="nom" placeholder="Votre nom ici.">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="prenom" placeholder="Votre prénom ici.">
                <small class="form-text text-muted text-warning">Ce champ est obligatoire *</small>
            </div>
